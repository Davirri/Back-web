import jwt from 'jsonwebtoken'; // Aquí importamos la biblioteca jsonwebtoken
...
export default authenticate; // Exportamos el middleware para usarlo en otras partes de la aplicación
